...
from .models import AdvUser, SubRubric, Bb, AdditionalImage, Comment
...
class SubRubricForm(forms.ModelForm):
    super_rubric = forms.ModelChoiceField(
        queryset=SubRubric.objects.all(), empty_label=None,
...
class UserCommentForm(forms.ModelForm):
    ...
    class Meta:
        model = Comment
        exclude = ('is_active',)
        widgets = {'bb': forms.HiddenInput, 'author': forms.TextInput(attrs={'readonly': 'readonly'})}
