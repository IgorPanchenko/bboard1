...
from bboard.utilities import get_timestamp_path, send_new_comment_notification
...
class Rubric(models.Model):
    name = models.CharField(max_length=20, db_index=True, unique=False, verbose_name='Название')
...
class Bb(models.Model):
    ...
    author = models.ForeignKey(AdvUser, on_delete=models.CASCADE, verbose_name='Автор обновления')
